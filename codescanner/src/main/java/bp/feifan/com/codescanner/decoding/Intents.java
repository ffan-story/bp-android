...
public final class Intents {
  ...
  public static final class Scan {
     ...
     * {@link android.app.Activity#onActivityResult(int, int, android.content.Intent)} of the app
     * which requested the scan via
     * {@link android.app.Activity#startActivityForResult(android.content.Intent, int)} The barcodes
     * contents can be retrieved with {@link android.content.Intent#getStringExtra(String)}. If the
     * user
     * presses Back, the result code will be {@link android.app.Activity#RESULT_CANCELED}.
     */
    public static final String RESULT = "SCAN_RESULT";

    /**
     * Call {@link android.content.Intent#getStringExtra(String)} with {@link #RESULT_FORMAT} to
     * determine which barcode format was found.
    ...
    /**
     * Call {@link android.content.Intent#getByteArrayExtra(String)} with {@link #RESULT_BYTES} to
     * get a {@code byte[]} of raw bytes in the
     ...
     * available. Call {@link android.content.Intent#getIntArrayExtra(String)} with
     ...
     * if available. Call {@link android.content.Intent#getStringExtra(String)} with
  ...
  public static final class Encode {
     ...
     * blank, it defaults to QR Code. Use {@link android.content.Intent#putExtra(String, String)},
     * where format
