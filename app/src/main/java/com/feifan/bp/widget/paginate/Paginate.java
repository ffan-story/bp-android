package com.feifan.bp.widget.paginate;

import android.support.v7.widget.RecyclerView;
import android.widget.AbsListView;

import com.feifan.bp.widget.paginate.abslistview.AbsListViewPaginate;
import com.feifan.bp.widget.paginate.recycler.RecyclerPaginate;
...
public abstract class Paginate {
    ...
    public interface Callbacks {
         ...
         * com.feifan.bp.widget.paginate.Paginate.Callbacks#onLoadMore} won't be called and loading row, if used, won't be added.
         *
     ...
     * @return {@link com.feifan.bp.widget.paginate.recycler.RecyclerPaginate.Builder}
     */
     ...
     * @param callback    pagination callbacks.
     * @return {@link com.feifan.bp.widget.paginate.abslistview.AbsListViewPaginate.Builder}
     */
