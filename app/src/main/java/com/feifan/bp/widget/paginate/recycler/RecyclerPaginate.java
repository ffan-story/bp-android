...
public final class RecyclerPaginate extends Paginate {
    ...
    private final RecyclerView.OnScrollListener mOnScrollListener = new RecyclerView.OnScrollListener() {
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            if(dy > loadingTriggerThreshold){ //防止触摸抖动，超过该阀值时认为是有效滑动
    ...
    public static class Builder {
         ...
         * @return {@link com.feifan.bp.widget.paginate.recycler.RecyclerPaginate.Builder}
         * @see {@link com.feifan.bp.widget.paginate.Paginate.Callbacks#hasLoadedAllItems()}
         * @see {@link com.feifan.bp.widget.paginate.recycler.RecyclerPaginate.Builder#setLoadingListItemCreator(LoadingListItemCreator)}
         */
