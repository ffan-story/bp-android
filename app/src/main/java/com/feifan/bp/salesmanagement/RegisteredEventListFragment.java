 ...
 */
public class RegisteredEventListFragment extends ProgressFragment implements Paginate.Callbacks,SwipeRefreshLayout.OnRefreshListener,PlatformTabActivity.onPageSelectListener{
    ...
    private void setupPagination() {
        ...
        adapter = new EventListAdapter(getActivity(),DataProvider.getRandomData(pageSize),true);
        loading = false;
        page = 0;
