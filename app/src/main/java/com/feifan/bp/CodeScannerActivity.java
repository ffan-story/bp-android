...
public class CodeScannerActivity extends BaseActivity implements CaptureActivityOfResult {
    ...
    public void getScanCodeResult(String resultText, long timeStamp, String barcodeFormat) {
        ...
        if (resultText.length()==10){//提货码
            args.putString(ErrorFragment.EXTRA_KEY_ERROR_MESSAGE,resultText);
            PlatformTopbarActivity.startActivity(this,"", getApplicationContext().getString(R.string.query_result),args);
            return;
