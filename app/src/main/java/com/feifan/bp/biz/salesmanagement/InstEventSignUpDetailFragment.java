...
public class InstEventSignUpDetailFragment extends ProgressFragment {
    ...
    private List<com.feifan.bp.biz.salesmanagement.InstEvenSkuSettModel.InstantEventSetDetailData> mList = new ArrayList<>();
    /**
    ...
    protected void requestData(){
        ...
        com.feifan.bp.biz.salesmanagement.InstCtrl.getInstEventGoodsSetingDeta(mStrEventId, mStrGoodsCode, mgoodsAction, new Response.Listener<com.feifan.bp.biz.salesmanagement.InstEvenSkuSettModel>() {
            @Override
            public void onResponse(com.feifan.bp.biz.salesmanagement.InstEvenSkuSettModel detailModel) {
                if (detailModel != null) {
    ...
    com.feifan.bp.biz.salesmanagement.InstEvenSkuSettModel.InstantEventSetDetailData myData ;
    private void setContViewData(com.feifan.bp.biz.salesmanagement.InstEvenSkuSettModel detailModel){
