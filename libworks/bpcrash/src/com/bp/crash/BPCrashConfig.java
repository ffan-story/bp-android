...
public class BPCrashConfig implements IConfiguration {
    ...
    public static String getServerUrl(boolean isDebug) {
        if(isDebug) {
    ...
    private String getBaseUrl() {
        String url = getServerUrl(isApkDebugable(mContext));
        Log.e("BuildConfig.DEBUG",String.valueOf(isApkDebugable(mContext)));
        Log.e("crash url",url);
        return url;
    }
    ...
    private class HttpPolicy extends AbstractHttpPolicy {
        ...
        public HttpParams getHttpParams() {
            ...
            Log.e("versioncode",String.valueOf(SystemUtil.getVersionCode(mContext)));
